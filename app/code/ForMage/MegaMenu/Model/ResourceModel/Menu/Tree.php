...
use ForMage\MegaMenu\Model\ResourceModel\Menu;
...
class Tree extends Dbp
{
     ...
     * Collection factory
     *
     * @var \ForMage\MegaMenu\Model\ResourceModel\Menu\CollectionFactory
     */
    public $collectionFactory;

    /**
     * MegaMenu Resource instance
     *
     * @var \ForMage\MegaMenu\Model\ResourceModel\Menu
     */
    ...
    )
    {
        ...
        parent::__construct(
            $coreResource->getConnection('4mage_menu_write'),
            $coreResource->getTableName('4mage_menu'),
            [
                Dbp::ID_FIELD => 'menu_id',
                Dbp::PATH_FIELD => 'path',
    ...
    )
    {
        ...
        if ($onlyActive) {
            ...
            if ($disabledIds) {
                $collection->addFieldToFilter('menu_id', ['nin' => $disabledIds]);
            }
        }
    ...
    public function initInactiveCategoryIds()
    {
        ...
        $this->eventManager->dispatch('formage_menu_tree_init_inactive_category_ids', ['tree' => $this]);
    ...
    {
        $this->cache->clean([\ForMage\MegaMenu\Model\Menu::CACHE_TAG]);
